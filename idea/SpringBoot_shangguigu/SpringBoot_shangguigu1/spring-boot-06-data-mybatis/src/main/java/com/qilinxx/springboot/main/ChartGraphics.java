package com.qilinxx.springboot.main;
...
public class ChartGraphics {
    ...
    public void graphicsGeneration(String name, String id, String classname, String imgurl) {
        ...
        //设置字体
        Font titleFont = new Font("华文新魏",Font.BOLD,16);
        ...
        //设置字体
        Font tipFont = new Font("华文新魏",Font.BOLD,20);
        tip.setFont(tipFont);
    ...
    public static void main(String[] args) {
        ...
        try {
            cg.graphicsGeneration("ewew", "1", "12", "E:\\1.jpg");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
